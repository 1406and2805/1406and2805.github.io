const contentLetterSrart_actived = "Hi Phan Lan Anh! Anh muốn nói:'Chúc mừng sinh nhật vợ yêu nha.'" //Lời mở đầu cho bức thư
...
document.querySelector(".sticker").addEventListener("click", function () { //Hiệu ứng gõ chữ cho phần mở đầu của bức thư
    ...
    setTimeout(() => {
        splitContentLetterSrart_actived.forEach((val, index) => {
            setTimeout(() => {
                if (val === ":") {
                    document.querySelector(".contentLetter").innerHTML += val + "<br>";
                } else {
